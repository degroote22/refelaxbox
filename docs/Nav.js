...
import { inc, dec, toggleXRay, cycleColor } from "./updaters";
  ...
  return (
    <nav style={sx.root}>
      <Flex px={[0, 1, 2]} py={1} align="center">
        ...
        />
        <Box ml="auto" />
        <Button onClick={e => props.update(toggleXRay)} children="X-Ray" />
        <Button onClick={e => props.update(cycleColor)} children="Color" />
